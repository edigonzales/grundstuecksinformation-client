 ...
 *         &lt;element name="PendingTransaction" type="{http://geo.so.ch/schema/AGI/Cadastre/0.9/Extract}Transaction" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class RealEstateDPR {
    ...
    @XmlElement(name = "PendingTransaction")
    ...
    /**
     * Gets the value of the pendingTransactions property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the pendingTransactions property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getPendingTransactions().add(newItem);
     * </pre>
     * 
     * 
     * <p>
