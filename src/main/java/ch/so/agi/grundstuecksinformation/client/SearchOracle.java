...
public class SearchOracle extends SuggestOracle {
	...
	public void requestSuggestions(SuggestOracle.Request suggestRequest, SuggestOracle.Callback callback) {
		...
		// Im Prinzip funktioniert das. Mir ist jedoch noch nicht
		// klar (api-mässig) wie man Header setzt etc. War bei
		// uns notwendig wegen CORS.
		// Auch den Request canceln ist jedenfalls beim alten
		// Approach notwendig. Wäre mir auch nicht klar mit
		// fetch. Es gibt zwar etwas wie einen AbortController.
		// Den müsste man aber nachbauen, da nicht im Java-Api
		// vorhanden.
